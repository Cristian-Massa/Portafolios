...
`
export const Home = () =>{
    const randomTitle = ['¡Bienvenido/a a mi repositorio! Agradecemos tu interés y esperamos que encuentres valiosa información aquí.', 'Saludos cordiales, y bienvenido/a al repositorio de Cristian Massa. Esperamos que encuentres útiles los recursos que hemos preparado para ti.', 'Me complace que hayas decidido echar un vistazo a mi Portafolios. Si necesitas ayuda, no dudes en contactarme.', '¡Espero que encuentres nuestra colección de recursos útil y relevante!']
